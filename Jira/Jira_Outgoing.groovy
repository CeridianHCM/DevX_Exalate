...
replica.customKeys."reporter_email"  = issue.reporter?.email ?: "EMPTYJ"
replica.customKeys."assignee_email".value  = issue.assignee?.email ?: "EMPTYJ"
...
replica.customFields."assignee_email".value  = issue.assignee?.email ?: "EMPTYJ"